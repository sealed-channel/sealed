...
abstract class ChainWallet {
  ...
  /// Algorand: 24-word BIP39 phrase (256-bit entropy).
  Future<void> createWallet();

  /// Restore wallet from an existing recovery phrase.
  /// Algorand accepts 24-word BIP39 (current), 25-word Algorand-native
  /// (legacy), or 12-word BIP39 (oldest legacy) — see implementation for
  /// derivation rules.
